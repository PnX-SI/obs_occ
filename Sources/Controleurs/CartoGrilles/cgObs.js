...
function basculeEcran(sens) {
    ...
    var filtres = new Ext.ux.grid.GridFilters({
        ...
        filters: [{type: 'numeric', dataIndex: 'id_obs', menuItemCfgs : {emptyText: ''}},
            ...
            {type: 'string', dataIndex: 'date_textuelle', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'nom_vern', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'nom_complet', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'cd_nom', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'phylum', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'classe', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'ordre', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'famille', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'nom_valide', emptyText: 'Val1||Val2||IS NULL'},
            ...
            {type: 'string', dataIndex: 'effectif_textuel', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'type_effectif', emptyText: 'Val1||Val2||IS NULL'},
            ...
            {type: 'string', dataIndex: 'localisation', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'code_insee', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'id_lieu_dit', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'lieu_dit', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'commune', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'dep', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'depart', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'observateur', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'validateur', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'structure', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'numeric', dataIndex: 'id_etude', menuItemCfgs : {emptyText: ''}},
            {type: 'numeric', dataIndex: 'id_protocole', menuItemCfgs : {emptyText: ''}},
            {type: 'string', dataIndex: 'remarque_obs', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'nom_etude', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'libelle', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'numerisat', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'boolean', dataIndex: 'diffusable', defaultValue: null, yesText: 'Oui', noText: 'Non'},
            {type: 'string', dataIndex: 'validat', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'observat', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'struct', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'commentaire_photo', emptyText: 'Val1||Val2||IS NULL'},
            {type: 'string', dataIndex: 'url_photo', emptyText: 'Val1||Val2||IS NULL'}
        ]
    });
    ...
    var configCols = new Ext.MyColumnModel({
        ...
        columns: [
            ...
            {dataIndex: 'date_obs', header: 'Date obs.', renderer: dateRenderer},
            {dataIndex: 'date_debut_obs', header: 'Début obs.', renderer: dateRenderer, hidden: true},
            {dataIndex: 'date_fin_obs', header: 'Fin obs.', renderer: dateRenderer, hidden: true},
