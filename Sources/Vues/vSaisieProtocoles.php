<?php
    ...
    if (decrypteRSA($_GET['appli'], $_SESSION[$_GET['appli']]['numerisateur']['droit']) != 'admin') {
         header('Location: vSaisieObs.php?appli=' . $_GET['appli']);
    }
?>
<html>
    <head>
        ...
        <!--Formulaires -->
        <script type="text/javascript" src="../Controleurs/Formulaires/frmProtocole.js"></script>
        <!-- CartoGrille (obligatoirement après "Formulaires")-->
        <script type="text/javascript" src="../Controleurs/Grilles/gProtocoles.js"></script>        
    </head>
    <body>        
    </body>
</html>
